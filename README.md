# RISCV-Computer-Organization
A comprehensive portfolio of RISC-V assembly programming, processor datapath design, and memory hierarchy   simulations from the HY-225 Computer Organization course.


# Computer Organization (HY-225) - Lab Portfolio

This repository contains the complete laboratory exercises and assignments for the **CSD HY-225 (Computer Organization)** course at the University of Crete (Spring 2024).
...
- **Processor Design**: Single-cycle datapath analysis and implementation.
- **Performance Optimization**: 5-stage pipelining, hazard detection (Data/Control), forwarding, and branch prediction.
...
---
*Disclaimer: This repository is intended to showcase my academic work. If you are a current student, please use this for reference only and adhere to your university's academic integrity policy.*
